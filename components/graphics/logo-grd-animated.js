export default props => {
  ...
  return <svg className='grd-logo' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1904.4 743.46'>
    ...
    @keyframes icon-green {
      0% {
        opacity: 0;
        transform: translate(44px, 36.03px);
      }
      100% {
        opacity: 1;
        transform: translate(-24px, -16.03px);
      }
    }
    @keyframes icon-gray {
      0% {
    ...
    @keyframes icon-red {
      0% {
        opacity: 0;
        transform: translate(604px, 200px);
      }
      100% {
        opacity: 1;
        transform: translate(-24px, -16.03px);
    ...
    @keyframes text-green {
      0% {
        opacity: 0;
        transform: translate(-644px, -90px);
      }
      100% {
        opacity: 1;
        transform: translate(-24px, -16.03px);
    ...
    @keyframes text-roof {
      0% {
        opacity: 0;
        transform: translate(-36px, 364px);
      }
      100% {
        opacity: 1;
        transform: translate(-24px, -16.03px);
    ...
    @keyframes text-diagnostics {
      0% {
        opacity: 0;
        transform: translate(-24px, 500px);
      }
      70% {
        opacity: 0;
        transform: translate(-24px, 500px);
    ...
    .grd-icon-green {
      animation-name: icon-green;
    }
    .grd-icon-gray {
      animation-name: icon-gray;
    }
    .grd-icon-red {
      animation-name: icon-red;
    }
    .grd-text-green {
      animation-name: text-green;
    }
    .grd-text-roof {
      animation-name: text-roof;
    }
    .grd-text-diagnostics {
      animation-name: text-diagnostics;
    }
    `}</style>
  </svg>
