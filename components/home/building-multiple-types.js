...
return <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1775 950'>
  <title>green roof detention for every building type</title>
    <g className='building'>
      <polygon className='building' points='1333.5 752.5 1333.5 583 924.5 583 924.5 414 671.5 414 671.5 133 671.5 53 652.5 53 652.5 133 440.5 133 440.5 53 421.5 53 421.5 133 421.5 414 421.5 583 319.5 583 319.5 752.5 183.5 752.5 183.5 922.5 1494.5 922.5 1494.5 752.5 1333.5 752.5'/>
    </g>

    <g className='blue-gray-lev-1'>
      <rect className='blue'   x='1333.5' y='731' width='161' height='20'/>
      <rect className='gray'   x='1333.5' y='711' width='161' height='18'/>
      <g className='label'>
        ...
        <path className='slash' d='M1634.76,738.33l6.26-25.89h3.81l-6.33,25.89Z'/>
    ...
    <g className='purple-lev-1'>
      <rect className='purple' x='183.5' y='731' width='136' height='20'/>
      <g className='label'>
        <path className='purple' d='M21.73,730.76H33A8.32,8.32,0,0,1,39.08,733a7.15,7.15,0,0,1,2.25,5.26,7.36,7.36,0,0,1-2.23,5.39A8.21,8.21,0,0,1,33,745.87H28V756H21.73ZM28,735.39v5.85H31q3.92,0,3.92-2.93a2.46,2.46,0,0,0-1-2.28,7.24,7.24,0,0,0-3.58-.64Z'/>
        <path className='purple' d='M64.46,730.76h6.29v14.33c0,3.68-1.09,6.48-3.27,8.38s-5.3,2.86-9.34,2.86-7.11-1-9.32-2.9-3.31-4.69-3.31-8.31V730.76h6.3v14.51a5.48,5.48,0,0,0,1.73,4.23,6.41,6.41,0,0,0,4.52,1.59,6.6,6.6,0,0,0,4.66-1.63,6,6,0,0,0,1.74-4.63Z'/>
        <path className='purple' d='M76.2,730.76H87.48a8.46,8.46,0,0,1,6,2.12A6.75,6.75,0,0,1,95.73,738q0,4.17-4.33,6.17c1.26.58,2.47,2.13,3.61,4.66s2.24,4.91,3.3,7.15H91.42c-.42-.83-1.13-2.41-2.16-4.75a14.72,14.72,0,0,0-2.62-4.5,3.44,3.44,0,0,0-2.34-1H82.49V756H76.2Zm6.29,4.63v5.74h3.32a3.9,3.9,0,0,0,2.52-.75,2.59,2.59,0,0,0,.93-2.14q0-2.85-3.59-2.85Z'/>
        <path className='purple' d='M101.49,730.76h11.26a8.32,8.32,0,0,1,6.09,2.22,7.16,7.16,0,0,1,2.26,5.26,7.4,7.4,0,0,1-2.23,5.39,8.22,8.22,0,0,1-6.08,2.24h-5V756h-6.29Zm6.29,4.63v5.85h2.93q3.92,0,3.92-2.93a2.46,2.46,0,0,0-1-2.28,7.24,7.24,0,0,0-3.58-.64Z'/>
        <path className='purple' d='M144.75,751.38V756H125.5V730.76h6.29v20.62Z'/>
        <path className='purple' d='M167,751.38V756H148.34V730.76H166.7v4.63H154.63v5.29h11.51v4.62H154.63v6.08Z'/>
      </g>
    </g>

    <g className='blue-green-lev-2'>
      <rect className='green'  x='924.5' y='541' width='366' height='18'/>
      <rect className='gray'   x='1293.5' y='541' width='40' height='18'/>
      <rect className='blue'   x='924.5' y='561' width='409' height='20'/>
      <g className='label'>
        ...
        <path className='slash' d='M1479.76,568.33l6.26-25.89h3.81l-6.33,25.89Z'/>
    ...
    <g className='purple-lev-2'>
      <rect className='purple' x='319.5' y='561' width='102' height='20'/>
      <g className='label'>
    ...
    <g className='purple-lev-3'>
      <rect className='purple' x='671.5' y='392' width='211' height='20'/>
    ...
    <g className='blue-gray-lev-4'>
      <rect className='gray'   x='440.5' y='91' width='212' height='18'/>
      <rect className='blue'   x='440.5' y='111' width='212' height='20'/>
      <rect className='mech mech-short' x='463' y='40.5' width='69' height='45'/>
      <rect className='mech mech-tall' x='559' y='25.5' width='69' height='60'/>
      <g className='label'>
        <path className='gray' d='M692.48,95.76h10.91a9.22,9.22,0,0,1,6.13,1.88,5.64,5.64,0,0,1,2.24,4.44c0,2.19-1.16,3.87-3.46,5a7.21,7.21,0,0,1,4,2.42,6.33,6.33,0,0,1,1.38,4,6.91,6.91,0,0,1-2.26,5.35q-2.25,2.06-6.65,2.06H692.48Zm6.29,4.63v5.4h3.28a3.37,3.37,0,0,0,2.37-.78,2.53,2.53,0,0,0,.85-2,2.43,2.43,0,0,0-.85-1.91,3.41,3.41,0,0,0-2.37-.76Zm0,10v6h3.54a7.07,7.07,0,0,0,3.61-.7,2.63,2.63,0,0,0,1.1-2.41,2.45,2.45,0,0,0-1-2.09,4.63,4.63,0,0,0-2.8-.77Z'/>
        <path className='gray' d='M737.55,116.38V121H718.31V95.76h6.29v20.62Z'/>
        <path className='gray' d='M759.79,95.76h6.29v14.33c0,3.68-1.09,6.48-3.27,8.38s-5.29,2.86-9.34,2.86-7.1-1-9.31-2.9-3.32-4.69-3.32-8.31V95.76h6.31v14.51a5.47,5.47,0,0,0,1.72,4.23,6.42,6.42,0,0,0,4.53,1.59,6.56,6.56,0,0,0,4.65-1.63,6,6,0,0,0,1.74-4.63Z'/>
        <path className='gray' d='M790.22,116.38V121H771.61V95.76H790v4.63H777.9v5.29h11.5v4.62H777.9v6.08Z'/>
        <path className='slash'd='M812.76,121.33,819,95.44h3.81l-6.33,25.89Z'/>
